            ...
            <div>
             ...
             <div>
                ...
                <div className='text-center mt-6 p-4'>
                    <button type='submit' className='bg-green-600 text-white w-70 md:w-100 rounded-lg cursor-pointer p-3 text-lg md:text-2xl    hover:bg-green-400'>Add Snippet</button>
                </div>
